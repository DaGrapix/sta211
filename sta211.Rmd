...
```{r chaines, fig.align='center', fig.cap="\\label{fig:chaines} Tracé des valeurs (pi, N) prises par les 3 chaines"}
par(mfrow=c(1, 3))
plot(chain1, xlab = "pi", ylab = "N")
plot(chain2, xlab = "pi", ylab = "N")
plot(chain3, xlab = "pi", ylab = "N")
```
...
Les autocorrélogrammes montrent des corrélations encore très élevées (<0.5) pour des lags de 40.
