...
On observe que le seul mode de la loi à postériori coincide avec la valeur de l'estimateur de maximum de vraissemblance de $\pi$.
C'est bon signe.
...
$$
\begin{align*}
\left[N=n, \pi=p, C_1=c_1, C_{20}=c_{20}, C_{21}=C_{21} \right] =\\ 
\left[N=n \right] \left[\pi=p | N=n \right] \left[C_1=c_1| \pi=p, N=n \right] \left[C_{20}=c_{20}, | \pi=p, N=n, C_1=c_1 \right] \left[C_{21}=c_{21} | \pi=p, N=n, C_1=c_1, C_{20}=c_{20}  \right]\\
\end{align*}
$$
